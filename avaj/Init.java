...
which will use it as a reference for the path of where to look for classes. 
As a result the first file from sources.txt won't be compiled
and you will have lots of errors poppin up.

So if we want to successfully compile the project with the given command, 
